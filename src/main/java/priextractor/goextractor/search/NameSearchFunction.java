...
public class NameSearchFunction {
    ...
    public boolean isPackageName(String name, int functionId) {
        ...
        Map<String, String> name2RoleMap = ((AbsFUNEntity) singleCollect.getEntityById(functionId)).getName2RoleMap();
    ...
    public int getIdByName(String name, int functionId) {
        ...
        Map<String, Integer> name2IdMap = ((AbsFUNEntity) singleCollect.getEntityById(functionId)).getName2IdMap();
