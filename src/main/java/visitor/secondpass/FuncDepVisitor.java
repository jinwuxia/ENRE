...
public class FuncDepVisitor {
    ...
    private void setCalls() {
        for (Entity functionOrMethodEntity : singleCollect.getEntities()) {
            if(functionOrMethodEntity instanceof FunctionEntity) {
                int callerEntityId = functionOrMethodEntity.getId(); //caller entity id
     ...
     * @param callerEntityId  the entity id of caller
     * @param calleeName     function or method name, without parameter "(..)"
     * @return               the entity id of callee
     */
    ...
    /**
     * search method in a Type (structType, AliasType, InterfaceType)
     * @param methodName
     * @param typeId
     * @return
     */
