...
public class AbsFUNEntity extends AbsEntity {
    ...
    //generate in the first visit. it will be used for localName entitydepanalyzer.goextractor.searcher.
   ...
   /* public HashMap<String, Integer> getCalledWeightedFunctions() {
    ...
    /**
     * entitydepanalyzer.goextractor.searcher the localName under same localBlock or parentBlock,
     * @param name
