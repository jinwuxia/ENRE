...
import udr.*;
import entitytreebuilder.gobuilder.goentity.*;
import util.OsUtil;
...
public class ProcessTask {
    ...
    public String getPackagePath(String fileFullPath) {
        ...
        //this way can help to entitydepanalyzer.goextractor.searcher the package which is imported in code.
        //
     ...
     * var here is surely a new variable, so save to udr
     * @param node
     * @param type
     * @param value
     * @param functionIndex
     ...
     *  if inside a function, we need to add this udr.
    ...
    public void processShortDeclVarInFunction(String leftOperands, String rightExps, int functionIndex, int localBlockId) {
        ...
        for (int i = 0; i < leftNames.length; i++) {
            ...
            //it 's not in localName, add this new udr
            saveLocalName(functionIndex, name, localBlockId, type, value, usage);
    ...
    public int processFunction(String functionName, String parameters, String returns, int fileIndex) {
        ...
        //set id, parentId and save into udr, add into function's parameter
        saveParameters(functionIndex, parameterVars, GoConstantString.SAVE_TYPE_PARAMETER);
        //set id, parentId and save into udr, add into function's return
    ...
    public int processMethod(String functionName, String receiverStr, String parameters, String returns, int fileIndex) {
        ...
        //set id, parentId, blockId, and save into udr, add into function's receiver
        saveReceiver(functionIndex, receiverVar);
        //set id, parentId, blockId, and save into udr, add into function's parameter
        saveParameters(functionIndex, parameterVars, GoConstantString.SAVE_TYPE_PARAMETER);
        //set id, parentId, blockId, and save into udr, add into function's return
        saveParameters(functionIndex, returnVars, GoConstantString.SAVE_TYPE_RETURN);
        return functionIndex;
    }
