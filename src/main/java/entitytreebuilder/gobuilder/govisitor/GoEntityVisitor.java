...
import parser.parsego.GolangBaseVisitor;
...
/**
 * nodes entitydepanalyzer.goextractor.visitor in the first visit
 */
public class GoEntityVisitor extends GolangBaseVisitor<String> {
    ...
    public String visitTypeSpec(GolangParser.TypeSpecContext ctx) {
        ...
        if (ctx.type().typeLit() != null && ctx.type().typeLit().structType() != null) {
            ...
            processTask.processTypeSpec(ctx, GoConstantString.STRUCT_TYPE, tmpEntitiesIds, fileIndex);
        ...
        //If it is InterfaceType declaration
            ...
            processTask.processTypeSpec(ctx, GoConstantString.INTERFACE_TYPE, tmpEntitiesIds, fileIndex);
            tmpEntitiesIds.clear();
        }
    ...
    public String visitStructType(GolangParser.StructTypeContext ctx) {
        if (!helperVisitor.isStructTypeInTypeDecl(ctx)) {
            String str = GoConstantString.STRING_STRUCT + Configure.LEFT_CURLY_BRACE;
    ...
    public String visitInterfaceType(GolangParser.InterfaceTypeContext ctx) {
        ...
        if (!helperVisitor.isInterfaceypeInTypeDecl(ctx)) {
            String str = GoConstantString.INTERFACE + Configure.LEFT_CURLY_BRACE;
            ...
            if (ctx.methodSpec() != null) {
                for (GolangParser.MethodSpecContext methodSpecContext : ctx.methodSpec()) {
                    ...
                    //methodDecl as a field
                        ...
                        type = GoConstantString.INTERFACE_FIELD_IS_METHOD; //"METHOD";
    ...
    public String visitFunctionType(GolangParser.FunctionTypeContext ctx) {
        return GoConstantString.STRING_FUNC + Configure.ONE_SPACE_STRING + visitSignature(ctx.signature());
    }
    ...
    public String visitMapType(GolangParser.MapTypeContext ctx) {
        return GoConstantString.MAP + Configure.LEFT_SQUARE_BRACKET + visitType(ctx.type()) + Configure.RIGHT_SQUARE_BRACKET + visitElementType(ctx.elementType());
    }
    ...
    public String visitFunctionLit(GolangParser.FunctionLitContext ctx) {
        return GoConstantString.STRING_FUNC + visitFunction(ctx.function());
    }
    ...
    public String visitFunction(GolangParser.FunctionContext ctx) {
        if(functionIndex != -1) {
            String localBlockName = GoConstantString.LOCAL_BLOCK_FUNCTION;
    ...
    public String visitBlock(GolangParser.BlockContext ctx) {
        ...
        if(helperVisitor.isBlockInStatement(ctx)) {
            if(functionIndex != -1) {
                String localBlockName = GoConstantString.LOCAL_BLOCK_UNNAMED_BLOCK;
                int localBlockId = newABlock(localBlockName);
                //push block stack
                blockStackForAFuncMeth.push(localBlockId);
            }
    ...
    public String visitForStmt(GolangParser.ForStmtContext ctx) {
        if(functionIndex != -1) {
            String localBlockName = GoConstantString.LOCAL_BLOCK_FOR;
            int localBlockId = newABlock(localBlockName);
            //push block stack
            blockStackForAFuncMeth.push(localBlockId);
        }
        ...
        //visit children
        String str = GoConstantString.STRING_FOR;
        if (ctx == null) {
            return str;
        }
        str += Configure.LEFT_PARENTHESES;
    ...
    public String visitIfStmtIf(GolangParser.IfStmtIfContext ctx) {
        if(functionIndex != -1) {
            //new block
            String localBlockName = GoConstantString.LOCAL_BLOCK_IF;
            int localBlockId = newABlock(localBlockName);
            //push block stack
            blockStackForAFuncMeth.push(localBlockId);
        }
        ...
        //visit children
        String str = GoConstantString.STRING_IF;
        if (ctx == null) {
            return str;
        }
        str += GoConstantString.STRING_IF;
    ...
    public String visitIfStmtElse(GolangParser.IfStmtElseContext ctx) {
        if(functionIndex != -1) {
            String localBlockName = GoConstantString.LOCAL_BLOCK_ELSE;
            int localBlockId = newABlock(localBlockName);
            //push block stack
            blockStackForAFuncMeth.push(localBlockId);
        }
        ...
        //visit children
        String str = GoConstantString.STRING_ELSE;
        if (ctx == null) {
            return str;
        }
        if(ctx.ifStmt() != null) {
    ...
    public String visitSwitchStmt(GolangParser.SwitchStmtContext ctx) {
        if(functionIndex != -1) {
            String localBlockName = GoConstantString.LOCAL_BLOCK_SWITCH;
            int localBlockId = newABlock(localBlockName);
            //push block stack
            blockStackForAFuncMeth.push(localBlockId);
        }
        ...
        //visit children
        String str = GoConstantString.STRING_SWITCH;
        if (ctx == null) {
            return str;
        }
    ...
    public String visitExprCaseClause(GolangParser.ExprCaseClauseContext ctx) {
        if(functionIndex != -1) {
            String localBlockName = GoConstantString.LOCAL_BLOCK_SWITCH_CASE_CLAUSE;
            int localBlockId = newABlock(localBlockName);
            //push block stack
            blockStackForAFuncMeth.push(localBlockId);
        }
    ...
    public String visitSelectStmt(GolangParser.SelectStmtContext ctx) {
        if(functionIndex != -1) {
            String localBlockName = GoConstantString.LOCAL_BLOCK_SELECT;
            int localBlockId = newABlock(localBlockName);
            //push block stack
            blockStackForAFuncMeth.push(localBlockId);
        }
        ...
        //visit children
        String str = GoConstantString.SELECT;
        if (ctx == null) {
            return str;
        }
    ...
    public String visitCommClause(GolangParser.CommClauseContext ctx) {
        if(functionIndex != -1) {
            String localBlockName = GoConstantString.LOCAL_BLOCK_SELECT_CASE_CLAUSE;
            int localBlockId = newABlock(localBlockName);
            //push block stack
            blockStackForAFuncMeth.push(localBlockId);
        }
