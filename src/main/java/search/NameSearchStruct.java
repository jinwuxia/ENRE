...
import entity.StructEntity;
import entity.StructFieldEntity;
...
public class NameSearchStruct {
     ...
     * it is like a breadSearch, first search the member fields.(outlayer hide the inner one when the same memberName)
     * if not,  then search the first layer children structs,
     * if not, then search the second layer children structs,
     * go on .....
     * @param fieldName
     * @param structId
     * @return
     ...
     * it is like a breadSearch, first search the member methodName.(outlayer hide the inner one when the same memberName)
     * if not,  then search the first layer children structs,
     * if not, then search the second layer children structs,
     * go on .....
     * @param methodName
