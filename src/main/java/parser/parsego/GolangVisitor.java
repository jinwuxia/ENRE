...
/**
 * This interface defines a complete generic entitydepanalyzer.goextractor.visitor for a parse tree produced
...
public interface GolangVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the entitydepanalyzer.goextractor.visitor result
	 */
