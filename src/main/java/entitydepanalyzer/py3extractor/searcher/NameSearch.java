...
/**
 * build scopeMap for each udr
 *  in each scope (module, class, function, method), record the visible name and its binding udr
 *
...
public class NameSearch {
    ...
    /**
     * in scope with scopeId, get the udr Id by name.
