...
import udr.*;
import entitytreebuilder.gobuilder.goentity.Signature;
...
public class BasicDepVisitor {
                ...
                for (int fieldId : entity.getChildrenIds()) {
                    ...
                    if (fieldEntity instanceof StructFieldEntity) {
                        if (fieldEntity.getName().equals(GoConstantString.STRUCT_FIELD_IS_ANONYMOUS)) {
                            ...
                            //System.out.println("StructRelation: struct:"+ udr.getName() + ", file:" +  fileName1);
    ...
    /**
     * entitydepanalyzer.goextractor.searcher the udr (struct type or alias type) id of receiver type for methodEntityId
