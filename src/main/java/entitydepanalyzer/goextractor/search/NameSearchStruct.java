...
public class NameSearchStruct {
     ...
     * it is like a breadSearch, first entitydepanalyzer.goextractor.searcher the member fields.(outlayer hide the inner one when the same memberName)
     * if not,  then entitydepanalyzer.goextractor.searcher the first layer children structs,
     * if not, then entitydepanalyzer.goextractor.searcher the second layer children structs,
     * go on .....
     * @param fieldName
     * @param structId
     * @return
