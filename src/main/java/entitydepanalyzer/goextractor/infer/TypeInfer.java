package entitydepanalyzer.goextractor.infer;

import entitytreebuilder.gobuilder.GoConstantString;
import udr.*;
import entitydepanalyzer.goextractor.search.NameSearchFile;
import entitydepanalyzer.goextractor.search.NameSearchPackage;
...
public class TypeInfer {
    ...
    /**
     * for each varEntity, entitydepanalyzer.goextractor.infer its typeId
     */
    ...
    /** now we can entitydepanalyzer.goextractor.infer X or X.X .  but not X.X.X,,,,,,
     * according to the typeName used in this file, entitydepanalyzer.goextractor.searcher the typeId
     * @param typeName
     * @param fileId
     * @return
     */
    private int searchTypeId(String typeName, int fileId) {
        ...
        if(arr.length == 1) {
            //entitydepanalyzer.goextractor.searcher Type in this package
