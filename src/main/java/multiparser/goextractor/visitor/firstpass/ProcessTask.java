...
public class ProcessTask {
     ...
     * and save into multiparser.entity
    ...
    /** add interfaceField into multiparser.entity,
     * and return its id.
    ...
    /**
     * add structfield into multiparser.entity,
     * and return its id.
     * its parentId is unknown.
     * @param fieldType
     * @param fieldName
    ...
    /**
     * add aliasType into multiparser.entity
     * @param fileIndex
     * @param type
     * @param name
     */
    ...
    public String getPackagePath(String fileFullPath) {
        ...
        //this way can help to multiparser.goextractor.search the package which is imported in code.
        //
     ...
     * var here is surely a new variable, so save to multiparser.entity
     * @param node
     * @param type
     * @param value
     * @param functionIndex
     ...
     *  if inside a function, we need to add this multiparser.entity.
    ...
    /**
     * process Function , save multiparser.entity
     * @param functionName
     * @param parameters
     * @param returns
     * @param fileIndex
    ...
    public int processFunction(String functionName, String parameters, String returns, int fileIndex) {
        ...
        //set id, parentId and save into multiparser.entity, add into function's parameter
        saveParameters(functionIndex, parameterVars, ConstantString.SAVE_TYPE_PARAMETER);
        //set id, parentId and save into multiparser.entity, add into function's return
    ...
    /**
     * process method, store into multiparser.entity
     * @param functionName
     * @param receiverStr
     * @param parameters
     * @param returns
    ...
    public int processMethod(String functionName, String receiverStr, String parameters, String returns, int fileIndex) {
        ...
        //set id, parentId, blockId, and save into multiparser.entity, add into function's receiver
        saveReceiver(functionIndex, receiverVar);
        //set id, parentId, blockId, and save into multiparser.entity, add into function's parameter
        saveParameters(functionIndex, parameterVars, ConstantString.SAVE_TYPE_PARAMETER);
        //set id, parentId, blockId, and save into multiparser.entity, add into function's return
        saveParameters(functionIndex, returnVars, ConstantString.SAVE_TYPE_RETURN);
        return functionIndex;
    }
