package multiparser.goextractor.infer;

import multiparser.entity.*;
import multiparser.goextractor.search.NameSearchFile;
...
public class TypeInfer {
    ...
    /**
     * for each varEntity, multiparser.goextractor.infer its typeId
     */
    ...
    /** now we can multiparser.goextractor.infer X or X.X .  but not X.X.X,,,,,,
     * according to the typeName used in this file, multiparser.goextractor.search the typeId
     * @param typeName
     * @param fileId
     * @return
     */
    private int searchTypeId(String typeName, int fileId) {
        ...
        if(arr.length == 1) {
            //multiparser.goextractor.search Type in this package
